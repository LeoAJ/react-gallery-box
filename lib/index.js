...
var ReactGalleryBox = function (_PureComponent) {
  _inherits(ReactGalleryBox, _PureComponent);
  ...
  function ReactGalleryBox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _PureComponent.call.apply(_PureComponent, [this].concat(args))), _this), _this.timer = null, _this.state = { visibleImageIndex: _this.props.visibleImageIndex }, _this.clearTimer = function () {
...
ReactGalleryBox.propTypes = Props;
